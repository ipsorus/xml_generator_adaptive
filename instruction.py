...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        item.setText(_translate("Form", "    а. Заполнить обязательное поле Тип СИ в реестре ФИФ ОЕИ (Наименование СИ (ГОСТ 8.326-78), Наименование СИ, поступившего в эксплуатацию до 01.06.1993), подробнее в примечании ниже;"))
...
"- «Тип СИ в реестре ФИФ ОЕИ» для внесения сведений о результатах поверки СИ утвержденного типа, при заполнении поля в данном случае выбирается значение из реестра утвержденных типов СИ ФИФ ОЕИ.\n"
"- «Наименование СИ (ГОСТ – 8.326-78)» для внесения сведений о результатах поверки средства измерений, прошедшего метрологическую аттестацию до 1 декабря 2001 г. по ГОСТ 8.326-78 «Государственная система обеспечения единства измерений. Методическое обеспечение разработки, изготовления и эксплуатации нестандартизованных средств измерений. Основные положения» или по ГОСТ 8.326-89 «Государственная система обеспечения единства измерений. Метрологическая аттестация средств измерений», при заполнении поля в данном случае указывается наименование СИ. \n"
"- «Наименование СИ, поступившего в эксплуатацию до 01.06.1993» для внесения сведений о результатах поверки средства измерений, поступившего в эксплуатацию до 01.06.1993 и подлежащего поверке по ГОСТ 8.513-84 «Государственная система обеспечения единства измерений. Поверка средств измерений. Организация и порядок проведения», при заполнении поля в данном случае указывается наименование СИ.\n"
""))
